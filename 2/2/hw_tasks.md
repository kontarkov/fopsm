...
## Решение 3:
* Выводим список блочных устройств компьютера. Работаем с устройствами `sdb` и `sdc`.
  
![1](./images/2_1.png)  

* Убеждаемся в отсутствии разделов на устройстве sdb. Создаём таблицу MBR и первый PRIMARY раздел.
